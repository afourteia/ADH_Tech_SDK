...
protected:
	...
	DECLARE_MESSAGE_MAP()
public:
	afx_msg void OnBnClickedButtModuleInfo();
	afx_msg void OnBnClickedButtSetSecurityLevel();
	afx_msg void OnBnClickedButtGetSecurityLevel();
};
